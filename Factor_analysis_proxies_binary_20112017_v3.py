...
fig.savefig('Figures/Dimension_reduction/FA_parallel_binary_20112017.png')
...
fa_pm_loadings.to_csv('Results/fa_binary_loadings_promax_20112017.csv')
...
# Save
text_fa_table_latex_latex = open('Results/EFA_binary_20112017.tex', 'w')
